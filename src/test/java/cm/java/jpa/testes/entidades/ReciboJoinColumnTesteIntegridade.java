...
/**
 * Classe responsável pelo teste unitario de ReciboJoinColumnTesteIntegridade
 * @author jaison.santos
 */
public class ReciboJoinColumnTesteIntegridade extends TestePersistenciaAbstrato {
